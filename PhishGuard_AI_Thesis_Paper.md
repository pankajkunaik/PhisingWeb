# PHISHGUARD AI: NEXT-GENERATION MACHINE LEARNING PLATFORM AND EXPLAINABLE AI ENGINE FOR REAL-TIME PHISHING WEBSITE DETECTION AND THREAT INTELLIGENCE
...
| Feature / Capability | Static Blacklists | Heuristic Rules | Standard ML Models | PhishGuard AI |
| --- | --- | --- | --- | --- |
...
| Layer / Subsystem | Technology Selected | Version | Selection Rationale |
| --- | --- | --- | --- |
...
| Feature Name | Benign Distribution | Phishing Distribution | Statistical Impact |
| --- | --- | --- | --- |
...
| Hyperparameter Name | Configured Value | Technical Justification |
| --- | --- | --- |
...
| Risk Score Range | Classification Badge | Hex Color Code | Actionable Recommendation |
| --- | --- | --- | --- |
...
| HTTP Method | Endpoint Path | Auth Required | Rate Limit | Description & Purpose |
| --- | --- | --- | --- | --- |
...
| Actual / Predicted | Predicted Benign (0) | Predicted Phishing (1) | Total Class Samples |
| --- | --- | --- | --- |
...
| Rank | Feature Name | Feature Importance Weight | Category |
| --- | --- | --- | --- |
...
### B.1 Feature Extractor (`ml/features.py`)

```python
# Extract from ml/features.py
import re
...
### B.2 Machine Learning Model Trainer (`ml/train.py`)

```python
# Extract from ml/train.py
...
### B.3 FastAPI Backend Entrypoint (`backend/app/main.py`)
...
Refer to Chapter 6, Table 6.2 for complete API contracts.
